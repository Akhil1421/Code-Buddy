...
const PassResetMail = () => {
  ...
  const handleSubmit = async (e) => {
    try {
      ...
      e.preventDefault();
      const response = await axios.post('http://localhost:5000/auth/PassResetMail', { user_id: queryParameters.get('Token'), newPassword, }, {
        headers: {
      ...
      <div className="container">
        ...
        <div className="card">
          <div className="form">
            ...
            <input className="resetPassIn" value={confirmPassword} placeholder="Email" onChange={(e) => { setConfirmPassword(e.target.value) }} type="password" name="confirmPassword" id="confirmPassword" /><br />
